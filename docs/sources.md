...
| Curated local research context | Local PDF bundle / source matrix | Evidence cards for local caveats, methods, policy context, species-selection context, and geography-aware implementation notes | `source_extracts.local_research_context`; context-only, no score override | `scripts/extract-local-research-context.mjs`, `data/features/source_extracts/local_research_context.json` | Re-run when PDFs or the curated evidence index change | Context-derived for 16/16 sites; strongest explicit local match is Gimbo/SWE-007; newly pushed Bale/Konso/local plant sources are context/use-later |
...
| `Livestock and settlement - peer reviewed research paper may be useful for grazing patterns etc.pdf` | Bale Mountains livestock/settlement/wildlife pressure context | Context-only | Peer-reviewed local paper; geographically outside current candidate polygons |
| `1746-4269-6-20 - peer reviewed research paper on local plants and medicine knowledge.pdf` | Local plant-use/species-selection context, including `Hagenia abyssinica` | Context-only/species caveat | Peer-reviewed ethnobotany paper; species recommendations require local ecological QA |
| `Konso-20260627T215313Z-3-001.zip` | Konso dryland/cultural-landscape/soil-conservation context | Use-later context | Zip bundle needs manual unpacking/QA and is outside current candidate zones |
| `Lake Tana (Amhara)-20260627T215313Z-3-001.zip` | Lake Tana/Amhara context | Use-later context | Zip bundle outside current candidate geography |
| `Tigray (Tekeze)-20260627T215315Z-3-001.zip` | Tigray/Tekeze context | Use-later context | Zip bundle outside current candidate geography |
| `Overall govt directives-20260627T215314Z-3-001.zip` | Government directive context | Use-later context | Zip bundle needs manual unpacking/QA before use |
| `Belay Gurmessa - Doctoral Thesis.pdf` | Climate adaptation/smallholder context in Chiro, West Harerghe | Context-only | Outside current candidate geography |
| `Gemechu Yigezu - Doctoral Thesis (not fully the region).pdf` | Additional thesis context | Context-only | Geography and claims need manual QA |
| `Sibilo Gashure - Doctoral Thesis.pdf` | Konso-related thesis context | Use-later context | Outside current candidate zones; manual QA needed |
| `Unesco report.pdf`, `unesco report - semi useful.pdf`, `government report.pdf`, `migration-conservation-bale-mountains-ecosystem-report - government report semi useful.pdf` | Additional local/government/UNESCO context | Use-later/context-only | Duplicative or bundled reports; manual QA needed before frontend citation |
